...
export IMG_ES="docker.elastic.co/elasticsearch/elasticsearch:8.8.2"
...
# number of elasticsearch server 
export ES_NODE_NUM="3"

# name of the cluster:
export ES_CLUSTER_NAME="es-docker-cluster"
...
# ip
export ES_NODES_IP=("172.27.0.40" "172.27.0.41" "172.27.0.42")
